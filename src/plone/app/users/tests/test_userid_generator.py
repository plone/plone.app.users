...
class TestGenerateUserId(BaseTestCase):
    def test_custom_generator(self):
        ...
        data = {}
        self.assertEqual(generate_user_id(self.portal, data), "one")
    ...
    def test_default(self):
        ...
        """
        data = {}
        self.assertEqual(generate_user_id(self.portal, data), "")
        self.assertEqual(data.get("user_id"), "")

        # An explicit username is taken by default.
        data = {"username": "joe", "fullname": "Joe User", "email": "joe@example.org"}
        self.assertEqual(generate_user_id(self.portal, data), "joe")
        ...
        self.assertEqual(generate_user_id(self.portal, data), "joe-user")
        self.assertEqual(data.get("user_id"), "joe-user")

        # With no fullname, we take the email.
        data = {"email": "Joe@example.org"}
        self.assertEqual(generate_user_id(self.portal, data), "Joe@example.org")
    ...
    def test_use_uuid_as_userid_enabled(self):
        ...
        data = {}
        user_id = generate_user_id(self.portal, data)
        ...
        self.assertNotEqual(
            generate_user_id(self.portal, data), generate_user_id(self.portal, data)
        )
